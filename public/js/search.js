 ...
 * @param {Function} openFeature - 打开功能的函数
 * @param {Function} scrollToMessage - 滚动到消息的函数
 */
export function performSearch(searchInput, searchResults, messageMap, joined, currentFeature, openFeature, scrollToMessage) {
